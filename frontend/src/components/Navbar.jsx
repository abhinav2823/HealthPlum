...
const Navbar = () => {
  ...
  return (
    <nav className="xl:w-[1300px] px-4 mx-auto sticky top-0 z-50 transition-all duration-300 bg-white">
            ...
            {currentUser ? (
              <>
                <motion.button
                  ...
                  className="relative text-gray-500 hover:text-primary-600 transition-all mr-5"
                >
                ...
                <div className="relative">
                  ...
                  >
                    <div className="hidden lg:flex lg:items-center lg:gap-2">
                      ...
                      <div>
                        <p className="text-xs font-medium text-gray-700 group-hover:text-primary-700">
                          {currentUser.name || "User"}
                        </p>
                        <p className="text-xs text-gray-500">
                          {currentUser.role.charAt(0).toUpperCase() +
                            currentUser.role.slice(1).toLowerCase() || "Member"}
                        </p>
                      </div>
                    </div>
                  ...
                  <AnimatePresence>
                    {dropdownOpen && (
                      <motion.div
                        ...
                        className="absolute right-0 mt-2 w-30 bg-white rounded-lg py-1 z-20 border border-gray-100"
                      >
                        <Link
                          to={
